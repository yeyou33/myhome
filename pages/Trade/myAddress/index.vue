        ...
        <div style="margin: 40px 0 0 20px;">
          <el-form ref="form" :model="form" size="medium" label-width="120px">
            ...
            <el-form-item label="移动电话：">
              <el-input v-model="form.phone" style="width:248px;padding-right:20px;"></el-input>
              <label style="color:#E4393C;">移动电话和固定电话必填一项*</label>
            </el-form-item>
...
import personalIndexApi from "~/api/personalIndex";
export default {
  data() {
    return {
      citylist: [],
